...
class AppSettings(BaseSettings):
    ...
    cors_allow_origins: Union[list[AnyHttpUrl], CorsAllOrNone] = Field(
        ...
        default=None,
        description="Cross-origin resource sharing, either a comma separated list of HTTPS urls of the value `*` to allow CORS on all origins", # has nothing to do with a Continuously Operating Reference Station (CORS)
    )
